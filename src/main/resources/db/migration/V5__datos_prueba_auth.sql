...
-- Insertar sede PAI Bogotá (usa ON CONFLICT para no duplicar)
INSERT INTO shared.sedes (codigo, nombre, schema_name, ciudad, activa)
VALUES ('PAI_BOG', 'PAI Bogotá', 'sede_pai_bog', 'Bogotá', true)
...
-- Asignar admin a la sede (busca el UUID real por codigo)
...
SELECT
    ...
    true
FROM shared.sedes s WHERE s.codigo = 'PAI_BOG'
